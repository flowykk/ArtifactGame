...
public class Keys {
	...
	public static int TALKTOM = 10;
	public static int UNHITTABLE = 11;
	public static int BHEAL = 12;
	public static int APPLE = 13;
	public static int UPSPEED = 14;
	...
	public static void keySet(int i, boolean b) {
		...
		else if(i == KeyEvent.VK_G) keyState[TALKTOM] = b;
		else if(i == KeyEvent.VK_Y) keyState[UNHITTABLE] = b;
		else if(i == KeyEvent.VK_U) keyState[BHEAL] = b;
		else if(i == KeyEvent.VK_I) keyState[APPLE] = b;
		else if(i == KeyEvent.VK_O) keyState[UPSPEED] = b;
		//else if(i == KeyEvent.VK_P) keyState[UPSPEED] = b;
	}
